...
public class Solution {
	...
	public static void main(String[] args) throws Exception{
		...
		MinHeap heap = new MinHeap(entry+1);
...
class MinHeap{
	int maxSize;
	int size;
	Object[][] heap;//an array of String/Integer set
	final int headPos = 1;
	...
	MinHeap(int maxSize){
		...
		heap=new Object [maxSize+1][2];
		//heap starts at 1
		heap[0][0]="";
		heap[0][1]=Integer.MIN_VALUE;
		size=1;
	}
	void insert(String name, int cp) {
		heap[size][0]=name;
		heap[size][1]=cp;
		size++;
	}
